...
ctp_设置 = {
    ...
    "授权编码": "",
    "产品信息": "",
    "柜台环境": "实盘"  # 穿透性测试将 实盘 改为 测试
    # 提示：穿透性测试，如果需要 上期所 合约 报无仓位可平等错误信息提示，
    # 请将 xmpy.包_交易核心.模块_转换器 中第71行{类_交易所.上期所, 类_交易所.能源中心}删除：类_交易所.上期所，穿透性测试完成请恢复原样
}
